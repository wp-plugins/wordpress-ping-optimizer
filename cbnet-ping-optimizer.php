...
define('cbnetpo_VERSION', '2.31');					// Current version of the Plugin
...
class cbnetPingOptimizer 
{
	...
	function cbnetpoFooter() {
		echo '<p style="text-align:center;margin-top:3em;"><strong>'.cbnetpo_NAME.' '.cbnetpo_VERSION.' by <a href="http://onlinewebapplication.com/" target="_blank" >onlinewebapplication.com</a></strong></p>';
	}
